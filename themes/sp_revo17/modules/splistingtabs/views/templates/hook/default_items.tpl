 ...
 *}
{if isset($items) && !isset($items_params)}
...
{if !empty($child_items)}
    ...
    {foreach $child_items as $product key=spcount}
		{if $spcount % $nb_rows == 0}
			...
			<div class="thumbnail-container product-container">
				{block name='product_thumbnail'}
					<div class="product-image">
						<a href="{$product.url}" class="thumbnail product-thumbnail ver1">
							...
							{assign var="imageSize" value=($items_params['image_size'] != 'none') ? $items_params['image_size'] : 'home_default'}
								...
								<div class="cart_content">
										<div class="product-list-actions">
											<form action="{Context::getContext()->link->getPageLink('cart')}" method="post" class="add-to-cart-or-refresh">
													 ...
													 {if $items_params.display_quickview && isset($SP_MobileLayout) && $SP_MobileLayout && isset($isMobile_n) && $isMobile_n}
				...
				{if $spcount % $nb_rows == 1 || $spcount == ($count_item - 1)}
				</div>
				{/if}
