            ...
            <div class="moduletable clearfix {$moduleclass_sfx|escape:'html':'UTF-8'}">
                ...
                {if isset($items->title_module[$id_lang]) && $items->params.display_title_module}
                    <div class="title-module-listingtab">
                        <h3>{$items->title_module[$id_lang]|escape:'html':'UTF-8' nofilter}</h3>
                    </div>
                {/if}
                                ...
                                <div class="ltabs-items {$cls|escape:'html':'UTF-8'} {$cls2|escape:'html':'UTF-8'}">
                                    <div class="ltabs-items-inner product-listing {$class_ltabs|escape:'html':'UTF-8'} {$cls_animate|escape:'html':'UTF-8'}">
                                        {if !empty($child_items)}
                                            {include file="module:splistingtabs/views/templates/hook/default_items4.tpl" child_items=$child_items}
                                        {else}
