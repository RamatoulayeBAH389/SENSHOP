...
{if isset($list) && !empty($list)}
    {if isset($list) && !empty($list)}
        {foreach from=$list item=items}
            ...
            <div class="moduletable {$moduleclass_sfx|escape:'html':'UTF-8'} sp_listing_tab_2 clearfix">
                ...
                <div class="box-html col-lg-2 col-sm-3 col-xs-4"> 
                    ...
                    {/if}
                    <div class="splisting-banner">
						{hook h='displayBanner11'}
					</div>
                </div>

                <div id="{$tag_id|escape:'html':'UTF-8'}" class="sp-listing-tabs first-load col-lg-10 col-sm-9 col-xs-8"
					data-language_site = "{$language_site}"
					data-base_dir = "{$urls.base_url}"	
                    ...
                    <div class="ltabs-wrap">
                        ...
                        <div class="ltabs-tabs-container"
                            ...
                            {include file="module:splistingtabs/views/templates/hook/default_tabs.tpl" _list=$_list}
                        </div>
                        <!-- End Tabs-->
                                ...
                                <div class="ltabs-items {$cls|escape:'html':'UTF-8'} {$cls2|escape:'html':'UTF-8'}">
                                    <div class="ltabs-items-inner product-listing {$class_ltabs|escape:'html':'UTF-8'} {$cls_animate|escape:'html':'UTF-8'}">
                                        {if !empty($child_items)}
                                            {include file="module:splistingtabs/views/templates/hook/default_items2.tpl" child_items=$child_items}
                                        {else}
        ...
        {/foreach}
    {else}
        {l s='Has no content to show! In Module SpListingtabs' d='Shop.Theme.Global'}
    {/if}
{/if}
<!-- End SP Listing Tabs -->
