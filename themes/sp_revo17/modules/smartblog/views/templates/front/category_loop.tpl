            ...
            <div class="articleContent">
                <a title="{$post.meta_title}" class="imageFeaturedLink" href='{smartblog::GetSmartBlogLink('smartblog_post',$options)}'>
                    ...
                    <div class="date_added"> 
                        <h5 class="d" itemprop="dateCreated">{$post.created|date_format:"d"}</h5>
                        <h5 class="m" itemprop="dateCreated">{$post.created|date_format:"M"}</h5>
                    </div>
                </a>
                <div class="sdsarticle-text">
                    <div class="info-info">
                        ...
                        <!--<div class="sdsarticleDescription">
                            <div class="clearfix">
                                {$post.short_description|truncate:180:'...'|escape:'htmlall':'UTF-8'}
                           </div>
                        </div>-->
                            ...
                            <!--
                                <div class="sdsarticleMeta">
                                        ...
                                        {if $smartshowviewed ==1}
                                            <span class="metaView">
                                                <i class="fa fa-eye"></i>
                                                {l s='Views' d='Shop.Theme.Global'} ({$post.viewed})
                                            </span>
                                        {/if}
                                </div>
                            -->
