{capture name=path}<li class="depth1"><a href="{smartblog::GetSmartBlogLink('smartblog')}">{l s='All Blog News' d='Shop.Theme.Global'}</a></li>{$meta_title}{/capture}
<div id="content">
			...
			<div class="article-title">{$meta_title}</div>
			 <div class="article-info">
				...
				<a title="{if {$countcomment} < 1 } 0 Comment {else} {$countcomment} Comment(s) {/if}" href="">
					{if $countcomment > 1}
						{$countcomment} {l s='Comments' d='Shop.Theme.Global'}
					{else}
						{$countcomment} {l s='Comment' d='Shop.Theme.Global'}
					{/if}</a>
			</div>
			...
			<div class="bgr_tag">
				{if $tags != ''}
					<div class="sdstags-update">
						<span class="tags"><b class="title_tag">{l s='Tags:' d='Shop.Theme.Global'} </b> 
...
<div id="articleComments">
        <h3>{l s=' Comments' d='Shop.Theme.Global'} {if $countcomment != ''}({$countcomment}){else}{l s='0' d='Shop.Theme.Global'}{/if}<span></span></h3>
        <div id="comments">      
...
<div class="smartblogcomments" id="respond">
    ...
    <h4 class="comment-reply-title" id="reply-title">{l s='LEAVE YOUR COMMENTS'  d='Shop.Theme.Global'} <small style="float:right;">
                <a style="display: none;" href="/wp/sellya/sellya/this-is-a-post-with-preview-image/#respond" 
                   id="cancel-comment-reply-link" rel="nofollow">{l s='Cancel Reply'  d='Shop.Theme.Global'}</a>
            </small>
        </h4>
		<div id="commentInput">
	...
	{if Configuration::get('smartcaptchaoption') == '1'}
		<div class="capcha">
			...
			<span class="required">*</span> <b>{l s='Type Code' d='Shop.Theme.Global'}</b> </br>
