			...
			{assign var="options" value=null}
				  ...
				  <div class="sdsarticle-text">
				   ...
				   <div class="sdsarticleHeader">
					...
					<div class="sdsarticle-info">
						...
						<span class="comment"> <a 
							title="{if $post.totalcomment > 1}
								{$post.totalcomment} {l s='Comment(s)' d='Shop.Theme.Global'}
								{else}
					...
					<!--<div class="read-more">
						<a href="{smartblog::GetSmartBlogLink('smartblog_post',$options)}" class="more">{l s='see more' d='Shop.Theme.Global'} </a>	 
					</div>-->
				  </div>
