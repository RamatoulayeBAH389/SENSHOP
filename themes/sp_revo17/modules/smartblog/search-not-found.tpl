<div id="pagenotfound" class="row">
	...
	<div class="buttons"><a title="Home" href="{smartblog::GetSmartBlogLink('smartblog')}" class="btn btn-default button button-medium"><span><i class="fa fa-chevron-left left"></i>{l s='Home page' d='Shop.Theme.Global'}</span></a></div>
</div>
					</div>
										</div>