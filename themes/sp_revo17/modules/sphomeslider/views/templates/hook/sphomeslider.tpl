...
<!-- Module SpHomeSlider -->
    {if isset($sphomeslider_slides)}
		<div id="sphomepage-slider{$id_sphomeslider_groups}" class="sphomepage-slider sp-preload {if isset($params.moduleclass_sfx) && $params.moduleclass_sfx}{$params.moduleclass_sfx}{/if}"
