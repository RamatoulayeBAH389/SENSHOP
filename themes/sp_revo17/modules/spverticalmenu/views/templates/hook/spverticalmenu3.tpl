		...
		<div id="spverticalmenu_{$k}" class="spverticalmenu {$moduleclass_sfx|escape:'html':'UTF-8'}">
			...
			<nav class="navbar-default navbar-vertical">
				...
				<div id="sp-vermegamenu" class="sp-vermegamenu clearfix">
					...
					<h2 class="cat-title"><i class="fa fa-bars"></i>{$item.title}</h2>
		...
		<script type="text/javascript">{literal}
			$(document).ready(function() {
				...
				if($('#sp-vermegamenu .item-1').length > limit){	
                                    $('#sp-vermegamenu > ul').append('<div class="more-wrap"><i class="fa fa-plus-sign-alt"></i><span class="more-view">{/literal}{l s='More Categories' d='Shop.Theme.Global'}{literal}</span></div>');
                                }
				...
				$('#sp-vermegamenu .more-wrap').click(function(){
					if($(this).hasClass('open')){
						...
						$('.more-wrap').html('<i class="fa fa-plus-sign-alt"></i><span class="more-view">{/literal}{l s='More Categories' d='Shop.Theme.Global'}{literal}</span>');
					}else{
						$('#sp-vermegamenu .item-1').each(function(i){
							if(i>limit){
								$(this).slideDown(200);
						...
						$(this).addClass('open');
						$('.more-wrap').html('<i class="fa fa-minus-sign-alt"></i><span class="more-view">{/literal}{l s='Close Menu' d='Shop.Theme.Global'}{literal}</span>');
					}
				});
