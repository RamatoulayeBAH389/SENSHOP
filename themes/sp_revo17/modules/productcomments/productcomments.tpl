					...
					<div class="text">
						...
						<div>
							...
							{if $logged}
								...
								<span class="usefulness_btn" onclick="iFnLike(this)" data-is-usefull="1" data-id-product-comment="{$comment.id_product_comment}">{l s='Like' d='Shop.Theme.Global'}</span>
								<span class="usefulness_btn" onclick="iFnLike(this)" data-is-usefull="0" data-id-product-comment="{$comment.id_product_comment}">{l s='Dislike' d='Shop.Theme.Global'}</span>
								{/if}
								{if !$comment.customer_report}
								<span class="report_btn  pull-right" onclick="iFnReport(this)" data-id-product-comment="{$comment.id_product_comment}">{l s='Report' d='Shop.Theme.Global'}</span>
								{/if}
								</div>
							{/if}
						</div>
