...
{block name='content'}
    <section id="main">
        ...
        <section id="products" class="{$hiddenProductTitle} {$hiddenProductDesc} {$hiddenProductQuickView} {$hiddenProductPrice} {$hiddenProductLabel} {$hiddenProductColor} {$hiddenProductStock} {$hiddenProductCounter}">
            ...
            {else}
                <h2 class="h2">{l s='There are no products.' d='Shop.Theme.Global'}</h2>
            {/if}
        </section>
    </section>
{/block}
