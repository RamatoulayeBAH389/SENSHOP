          ...
          <div class="col-md-6 col-xs-6 qty">
			<div class="input-group bootstrap-touchspin">
				...
				{else}
				  ...
				  <input
					class="cart-line-product-quantity  form-control"
					...
					data-notice-quantity="{l s=' in your cart is no longer available in this quantity. It is decreased automatically.' d='Shop.Theme.Checkout'}"
					type="text"
