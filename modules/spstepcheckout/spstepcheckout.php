...
class SpStepCheckout extends Module implements WidgetInterface
{
     ...
     * @return array
     */
	public function getAllFields($object = null, $name_fields = []) {
	...
	public function getMediaFront()
    {
        ...
        if (!$this->configVars['SPSCO_REDIRECT_DIRECTLY_TO_SP'] || !Tools::getIsset('rc') || Tools::getIsset('checkout')) {
            ...
            $this->context->controller->addJS($this->_path.'views/js/front/spscovalid.js');
            $this->context->controller->addJS($this->_path.'views/js/front/spstepcheckout.js');
