...
class spBlocknewsletter extends Module
{
	...
	protected function sendVerificationEmail($email, $token)
	{
		$verif_url = Context::getContext()->link->getModuleLink(
			'spblocknewsletter', 'verification', array(
				'token' => $token,
			)
		);
	...
	public function hookdisplayNewLetter4($params)
	{
		if (!isset($this->prepared) || !$this->prepared)
			$this->_prepareHook($params);
		$this->prepared = true;
		return $this->display(__FILE__, 'blocknewsletter4.tpl');
	}
	...
	public function hookDisplayHeader($params)
	{
		...
		$this->context->controller->registerJavascript('jquery.cookie.min.js', '/assets/sp-js/jquery.cookie.min.js', ['position' => 'bottom', 'priority' => 98]);
		$this->context->controller->registerJavascript('spnewsletter.js', '/assets/sp-js/spnewsletter.js', ['position' => 'bottom', 'priority' => 99]);		
	}
