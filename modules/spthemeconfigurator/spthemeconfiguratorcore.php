...
class SPThemeConfiguratorCore extends Module {
	...
	public function getThemeFields() {
        ...
        foreach ($languages as $language) {
			$copyRighttext[$language['id_lang']] = '© 2019 Revoshop Theme Demo Store. All Rights Reserved. Designed by <a href="#">MagenTech.com</a>';
		...
		$themeFields = array(
			...
			// Layout Options
			'SP_themesColors'		=> '#ff5c00',
			'SP_themesColors2'		=> '#003764',
			'SP_themecolorrand'	=> '0',
			'SP_themecolorrandin'	=> '',
			...
			'SP_mainFont' 		=> 'Open Sans',
			'SP_headingsFont' 	=> 'Raleway',
			'SP_menuFont' 		=> 'Raleway',
			'SP_otherFont'		=> 'Raleway',
			...
			'SP_productZoom' => 1,
                        'SP_productZoom' => 'window',
			'SP_product_thumb' => 4,
			'SP_product_thumbtype' => 'false',
			'SP_product_rating' => 1,
			'SP_share_buttons' => 1,
			'SP_product_shortdesc' => 1,
			'SP_moreinfo' => 'product-moreinfo-tab',
			'SP_product_sku' => 1,
			...
			// Soical  Options
			'contact_text' => 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply.',
			'contact_address' => 'No 40 Baria Sreet 133/2 NewYork City, NY, United States',
			'contact_email' => 'contact@Revoshop.com',
			'contact_phone' => 'Phone 1 : 0123456789 Phone 2 : 0123456789',
			'social_in_footer' => 1,
            'social_facebook' => 'https://www.facebook.com/MagenTech.Themes/',
            'social_twitter' => 'https://twitter.com/MagenTech',
            'social_google' => 'plus.google.com/+MagenTech',
            'social_instagram' =>'#',
            'social_dribbble' =>'#',
            'social_flickr' =>'',
            'social_pinterest' => '',
   ...
   /* ------------------------------------------------------------- */
	...
	protected function generalSettings() {
		$fields_form = array(
			...
			$this->field_onOff('SP_MobileLayout', 'Mobile Layout','Enable Mobile Layout design for mobile devices'),
			 ...
			 array(
				 ...
				 'options' => array(
					'query' => array(
							...
							array('value' => 'header-v6', 'name' => 'Header Style 6'),
							array('value' => 'header-v7', 'name' => 'Header Style 7'),
							array('value' => 'header-v8', 'name' => 'Header Style 8')
					),
					'id' => 'value',
					'name' => 'name',
				 ),
			 ...
			 array(
				 ...
				 'options' => array(
					 'query' => array(
						...
						array('value' => 'content-v6', 'name' => 'Content Style 6'),
						array('value' => 'content-v7', 'name' => 'Content Style 7'),
						array('value' => 'content-v8', 'name' => 'Content Style 8')
					 ),
			 ...
			 array(
				 ...
				 'options' => array(
					 'query' => array(
						...
						array('value' => 'footer-v6', 'name' => 'Footer Style 6'),
						array('value' => 'footer-v7', 'name' => 'Footer Style 7'),
						array('value' => 'footer-v8', 'name' => 'Footer Style 8')
					 ),
	...
	protected function contactSettings() {
		$fields_form = array(
			$this->field_text('contact_text','Text (Layout 5)', 'input-xxlarge', false),
