        ...
        (function (element) {
            ...
            function CreateProSlider($items_inner) {
                $items_inner.owlCarousel({
                    ...
                    {*rtl: {$language_site},*}
                    responsive: {
                        0: {literal}{{/literal} items:{$items->params.nb_column4|escape:'html':'UTF-8'} {literal}}{/literal},
                        480: {literal}{{/literal}items:{$items->params.nb_column3|escape:'html':'UTF-8'}{literal}}{/literal},
                        768: {literal}{{/literal}items:{$items->params.nb_column2|escape:'html':'UTF-8'}{literal}}{/literal},
