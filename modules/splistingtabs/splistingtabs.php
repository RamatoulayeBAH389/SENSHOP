...
class SpListingTabs extends Module implements WidgetInterface
{
	...
	public function installFixtures()
	{
		...
		$datas = array(
			array(
				...
				'moduleclass_sfx' => 'sp_listing_tab_1',
				'active' => 1,
			...
			array(
				'id_splistingtabs' => 4,
				'title_module' => 'New Arrivals<span>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</span>',
				'display_title_module' => '1',
				'moduleclass_sfx' => 'sp_listing_tab_4',
				'active' => 1,
				...
				'cat_readmore_display' => 1,
				'display_icon' => 0,
				'image_size' => $this->_getImageSize('whatnew_default'),
				'display_name' => 1,
				'name_maxlength' => 50,
				'display_description' => 0,
				'description_maxlength' => 50,
			...
			array(
				'id_splistingtabs' => 5,
				'title_module' => 'Girl New Products<span>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</span>',
				'display_title_module' => '1',
				'moduleclass_sfx' => 'sp_listing_tab_4',
				'active' => 1,
			...
			array(
				'id_splistingtabs' => 6,
				'title_module' => 'Boy New Products<span>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</span>',
				'display_title_module' => '1',
				'moduleclass_sfx' => 'sp_listing_tab_4',
				'active' => 1,
			...
			array(
				...
				'moduleclass_sfx' => 'sp_listing_tab_4',
				'active' => 1,
				'hook' => Hook::getIdByName('displayListingTab8'),
				'nb_column1' => 4,
				'nb_column2' => 3,
				'nb_column3' => 2,
				'nb_column4' => 1,
				...
				'cat_readmore_display' => 1,
				'display_icon' => 0,
				'image_size' => $this->_getImageSize('layout6_default'),
				'display_name' => 1,
				'name_maxlength' => 50,
				'display_description' => 0,
				'description_maxlength' => 50,
			...
			array(
				'id_splistingtabs' => 9,
				'title_module' => 'Best seller products',
				'display_title_module' => '1',
				'moduleclass_sfx' => 'sp_listing_tab_7',
				'active' => 1,
				'hook' => Hook::getIdByName('displayListingTab9'),
				'nb_column1' => 4,
				'nb_column2' => 3,
				'nb_column3' => 2,
				'nb_column4' => 1,
	...
	public function getProducts($id_category = false, $params, $count_product = false, $product_filter = null)
	{
		...
		$only_active = true;
		$number_days_new_product = Configuration::get('PS_NB_DAYS_NEW_PRODUCT');;
	...
	public function hookHeader()
	{
		...
		$this->context->controller->registerJavascript('modules-splistingtabs', 'modules/'.$this->name.'/views/js/splistingtabs.js', ['position' => 'bottom', 'priority' => 150]);
	}

	public function renderWidget($hookName = null, array $configuration = [])
    {
		if ($hookName == 'displayListingTab2'){
			$templateFile = 'module:splistingtabs/views/templates/hook/default2.tpl';
		}
		elseif ($hookName == 'displayListingTab3'){
			$templateFile = 'module:splistingtabs/views/templates/hook/default3.tpl';
		}
		elseif ($hookName == 'displayListingTab4' || $hookName == 'displayListingTab6' || $hookName == 'displayListingTab8'){
			$templateFile = 'module:splistingtabs/views/templates/hook/default4.tpl';
		}
		elseif ($hookName == 'displayListingTab5' || $hookName == 'displayListingTab7'){
			$templateFile = 'module:splistingtabs/views/templates/hook/default5.tpl';
		}
		elseif ($hookName == 'displayListingTab9'){
			$templateFile = 'module:splistingtabs/views/templates/hook/default6.tpl';
		}
		else{
			$templateFile = 'module:splistingtabs/views/templates/hook/default.tpl';
		}
	...
	public function ajaxCall()
	{
		...
		if($mobileDetect->isMobile() == true && $mobileDetect->isTablet() == false){
			$ismobile_n = true;
		}else{
			$ismobile_n = false;
		}
		if (Tools::getValue ('is_ajax_listing_tabs') == 1)
		{
			...
			if ($id_splistingtabs == $listingtabs->id_splistingtabs)
			{
				...
				$smarty->assign (array(
					...
					'items_params' => $params,
					'condition'    => $conditon,
					'SP_secondimg' => Configuration::get('SP_secondimg')
				));
				if($ismobile_n){
					$result->items_markup = $this->display (__FILE__, 'default_items_mobile.tpl');	
				}else{
					if ($hookname == 'displayListingTab')
						$result->items_markup = $this->display (__FILE__, 'default_items.tpl');
					elseif ($hookname == 'displayListingTab2')
					...
					elseif ($hookname == 'displayListingTab7')
