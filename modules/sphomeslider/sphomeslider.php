...
{
	protected $_html = '';
	private $default_hook = array( 'displayHomeSlider', 'displayHomeSlider2', 'displayHomeSlider3', 'displayHomeSlider4','displayHomeSlider5', 'displayHomeSlider6', 'displayHomeSlider7', 'displayHomeSlider8', 'displayHomeSliderMobile');
		...
		$datas = array(
			...
			array(
				...
				'slider'		=> array(
					array('title' 		=> '#',
						'description'	=> '
											<div class="item-info group-1">
												<h3>FALL AHEAD</h3>
												<h2>NEW ARRIVALS</h2>
												<p>Shift into a new season with all<br /> our newest styles.</p>
												<h5><a href="#" class="slide-btn">shop for women</a></h5>
											 	<h5><a href="#" class="slide-btn">shop for men</a></h5>
											</div>
										',
						'legend'		=> '#',
						'url'			=> '#',
			...
			array(
				'title_module' 		=> 'HomeSlider 4',
				'position' 			=> 1,
				'active' 			=> 1,
				'display_title_module' 		=> 0,
				'id_sphomeslider_groups' 	=> 4,
				'hook'				=> 'displayHomeSlider4',
				'moduleclass_sfx' 	=> '',
				'autoplay'			=> 1,
				'autoplay_timeout'	=> 2000,
				'autoplaySpeed'		=> 2000,
				...
				'slider'		=> array(
					array('title' 		=> '#',
						'description'	=> '
												<div class="item-info group-4">
													<h3>FALL AHEAD</h3>
													<h2>NEW<br>ARRIVALS</h2>
													<h5><a href="#" class="slide-btn">shop for girls</a></h5>
												 	<h5><a href="#" class="slide-btn">shop for boys</a></h5>
												</div>
						',
						'legend'		=> '#',
						'url'			=> '#',
			...
			array(
				'title_module' 		=> 'HomeSlider 5',
				'position' 			=> 1,
				'active' 			=> 1,
				'display_title_module' 		=> 0,
				'id_sphomeslider_groups' 	=> 5,
				'hook'				=> 'displayHomeSlider5',
				'moduleclass_sfx' 	=> '',
				'autoplay'			=> 1,
				'autoplay_timeout'	=> 2000,
				'autoplaySpeed'		=> 2000,
			...
			array(
				'title_module' 		=> 'HomeSlider 6',
				'position' 			=> 1,
				'active' 			=> 1,
				'display_title_module' 		=> 0,
				'id_sphomeslider_groups' 	=> 6,
				'hook'				=> 'displayHomeSlider6',
				'moduleclass_sfx' 	=> '',
				'autoplay'			=> 1,
				'autoplay_timeout'	=> 2000,
				'autoplaySpeed'		=> 2000,
			...
			array(
				'title_module' 		=> 'HomeSlider Mobile',
				'position' 			=> 1,
				'active' 			=> 1,
				'display_title_module' 		=> 0,
				'id_sphomeslider_groups' 	=> 7,
				'hook'				=> 'displayHomeSliderMobile',
				'moduleclass_sfx' 	=> '',
				'autoplay'			=> 1,
				'autoplay_timeout'	=> 2000,
				'autoplaySpeed'		=> 2000,
			...
			array(
				'title_module' 		=> 'HomeSlider 7',
				'position' 			=> 1,
				'active' 			=> 1,
				'display_title_module' 		=> 0,
				'id_sphomeslider_groups' 	=> 8,
				'hook'				=> 'displayHomeSlider7',
				'moduleclass_sfx' 	=> '',
				'autoplay'			=> 1,
				'autoplay_timeout'	=> 2000,
				'autoplaySpeed'		=> 2000,
			...
			array(
				'title_module' 		=> 'HomeSlider 8',
				'position' 			=> 1,
				'active' 			=> 1,
				'display_title_module' 		=> 0,
				'id_sphomeslider_groups' 	=> 9,
				'hook'				=> 'displayHomeSlider8',
				'moduleclass_sfx' 	=> '',
				'autoplay'			=> 1,
				'autoplay_timeout'	=> 2000,
				'autoplaySpeed'		=> 2000,
	...
	public function hookdisplayHeader($params)
	{
		...
		$this->context->controller->registerJavascript('modules-sphomeslider', 'modules/'.$this->name.'/views/js/sphomeslider.js', ['position' => 'bottom', 'priority' => 150]);	
	}
	...
	public function hookdisplayHomeSlider($params)
	{
		...
		return $this->display (__FILE__, 'sphomeslider.tpl');
	}
	...
	public function hookdisplayHomeSlider3($params)
	{
		...
		return $this->display (__FILE__, 'sphomeslider-2.tpl');
	}
	...
	public function hookdisplayHomeSlider6($params)
	{
		if (!isset($this->context->controller->php_self) || $this->context->controller->php_self != 'index')
			return;
		if (!$this->_prepareHook('displayHomeSlider6'))
			return false;

		return $this->display (__FILE__, 'sphomeslider.tpl');
	}
	public function hookdisplayHomeSlider7($params)
	{
		if (!isset($this->context->controller->php_self) || $this->context->controller->php_self != 'index')
			return;
		if (!$this->_prepareHook('displayHomeSlider7'))
			return false;

		return $this->display (__FILE__, 'sphomeslider.tpl');
	}
	
	public function hookdisplayHomeSlider8($params)
	{
		if (!isset($this->context->controller->php_self) || $this->context->controller->php_self != 'index')
			return;
		if (!$this->_prepareHook('displayHomeSlider8'))
			return false;

		return $this->display (__FILE__, 'sphomeslider.tpl');
	}
	
	public function hookdisplayHomeSliderMobile($params)
	{
		if (!isset($this->context->controller->php_self) || $this->context->controller->php_self != 'index')
			return;	
		if (!$this->_prepareHook('displayHomeSliderMobile'))
			return false;
