...
class smartbloghomelatestnews extends Module {
     ...
     public function install(){
                ...
                $id_lang = (int) Configuration::get('PS_LANG_DEFAULT');
                 if (!parent::install() 
					...
					|| !$this->registerHook('displayHomeNews4')
					|| !$this->registerHook('displayHomeNews5')
            ...
            return true;
			   ...
			   public function hookdisplayHomeNews($params) {
				   ...
				   else
				   {
							   ...
							   return $this->display(__FILE__, 'smartblog_latest_news.tpl');
				   }  
			   }
			   ...
			   public function hookdisplayHomeNews2($params) {
				   ...
				   else
				   {
							   ...
							   return $this->display(__FILE__, 'smartblog_latest_news2.tpl');
				   }  
			   }
			   ...
			   public function hookdisplayHomeNews3($params) {
				   ...
				   else
				   {
							   ...
							   return $this->display(__FILE__, 'smartblog_latest_news3.tpl');
				   }  
			   }
            
			   public function hookdisplayHomeNews4($params) {
					 ...
					 else
					 {
								 ...
								 return $this->display(__FILE__, 'smartblog_latest_news4.tpl');
					 }  
			   }
			   
			   public function hookdisplayHomeNews5($params) {
					 ...
					 else
					 {
								 ...
								 return $this->display(__FILE__, 'smartblog_latest_news5.tpl');
					 }  
			   }
	...
	{
			$this->context->controller->registerJavascript('modules-smartbloghomelatestnews', 'modules/'.$this->name.'/views/js/smartbloghomelatestnews.js', ['position' => 'bottom', 'priority' => 150]);
	}
