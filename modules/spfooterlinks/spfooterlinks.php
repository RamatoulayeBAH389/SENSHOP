...
class SpFooterLinks extends Module
{
	...
	public function installFixtures()
	{
		$datas = array(
			array(
				'id_spfooterlinks' => 1,
				'title_module' => 'Our Shops',
				'moduleclass_sfx' => 'footer-links col-lg-2 col-sm-6',
				'display_title_module' => 1,
				'active' => 1,
				'hook' => Hook::getIdByName('displayFooterLinks'),
				'content' => '#',
				'text' 	=> 'Product Support,PC Setup & Support,Services,Extended Service Plans,Community',
				'link'	=> '#,#,#,#,#'
			),
			array(
				'id_spfooterlinks' => 2,
				'title_module' => 'Your Links',
				'moduleclass_sfx' => 'footer-links col-lg-2 col-sm-6',
				'display_title_module' => 1,
				'active' => 1,
				'hook' => Hook::getIdByName('displayFooterLinks2'),
				'content' => '#',
				'text' 	=> 'Shipping Guide,Store Location,Affiliate,Customer Point Policy,Term and Conditions',
				'link'	=> '#,#,#,#,#'
			),
			array(
				'id_spfooterlinks' => 3,
				'title_module' => 'Support',
				'moduleclass_sfx' => 'footer-links col-lg-2 col-sm-6',
				'display_title_module' => 1,
				'active' => 1,
				'hook' => Hook::getIdByName('displayFooterLinks3'),
				'content' => '#',
				'text' 	=> 'Product Support,PC Setup & Support,Services,New Arrivals,Clearance',
				'link'	=> '#,#,#,#,#'
			),
			array(
				'id_spfooterlinks' => 4,
				...
				'content' => '#',
				'text' 	=> 'Contact Us,About Us,F.A.Q,Help Center,Other',
				'link'	=> '../contact-us,../about-us,#,#,#'
			),
			array(
				'id_spfooterlinks' => 5,
				'title_module' => 'Our Shops',
				'moduleclass_sfx' => 'footer-links col-xl-2 col-lg-3 col-sm-6',
				'display_title_module' => 1,
				'active' => 1,
				'hook' => Hook::getIdByName('displayFooterLinks5'),
				'content' => '#',
				'text' 	=> 'New in,Bestsellers,Women,Men,Bags,Brands',
				'link'	=> '#,#,#,#,#,#'
			),
			array(
				'id_spfooterlinks' => 6,
			...
			array(
				...
				'content' => '#',
				'text' 	=> 'About Us,Our History,Store Locator,Careers,Terms and Conditions,Cookies and Privacy Policy',
				'link'	=> '#,#,#,#,#,#'
			),
			array(
				'id_spfooterlinks' => 8,
				'title_module' => 'Customer Services',
				'moduleclass_sfx' => 'footer-links col-xl-2 col-lg-3 col-sm-6',
				'display_title_module' => 1,
				'active' => 1,
				'hook' => Hook::getIdByName('displayFooterLinks8'),
				'content' => '#',
				'text' 	=> 'Contact Us,Delivery & Services,Returns & Exchanges,Payment & Security,FAQ,Gift Cards',
				'link'	=> '../contact-us,../about-us,#,#,#,#'
			)
		);
		$return = true;
