...
class SpExtraSlider extends Module
{
	...
	private $html;
	private $default_hook = array('displayExtraSlider', 'displayExtraSlider2', 'displayExtraSlider3', 'displayExtraSlider4' , 'displayExtraSlider5',
								  'displayExtraSlider6' , 'displayExtraSlider7', 'displayExtraSlider8', 'displayExtraSlider9',  'displayExtraSlider10', 'displayLeftColumn' );
	...
	public function installFixtures()
	{
		...
		$datas = array(
			...
			array(
				'id_spextraslider' => 3,
				'moduleclass_sfx' => 'sp-extra-1 sp-extra-2 clearfix',
				'display_title_module' => 1,
				'title_module' => 'Weekly Products',
				'active' => 1,
			...
			array(
				...
				'moduleclass_sfx' => '',
				'display_title_module' => 1,
				'title_module' => 'BEST SELLER <span>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</span>',
				'active' => 1,
			...
			array(
				'id_spextraslider' => 6,
				'moduleclass_sfx' => 'sp-extra-1 hot-product',
				'display_title_module' => 1,
				'title_module' => '<span>Top</span> Products',
				'active' => 1,
			...
			array(
				'id_spextraslider' => 7,
				'moduleclass_sfx' => 'sp-extra-4',
				'display_title_module' => 1,
				'title_module' => '<span>New</span> Arrivals',
				'active' => 1,
			...
			array(
				'id_spextraslider' => 8,
				'moduleclass_sfx' => 'sp-extra-3 sp-extra-5',
				'display_title_module' => 1,
				'title_module' => '<span>Most</span> viewed',
				'active' => 1,
			...
			array(
				...
				'title_module' => '<span>New</span> Arrivals',
				'active' => 1,
				'hook' => Hook::getIdByName('displayExtraSlider9'),
				'nb_column1' => 5,
				'nb_column2' => 4,
				'nb_column3' => 3,
				'nb_column4' => 1,
			...
			array(
				'id_spextraslider' => 11,
				'moduleclass_sfx' => 'sp-extra-layout-8',
				'display_title_module' => 1,
				'title_module' => 'Featured Products <span>Featured collections created and curated by our editors.</span>',
				'active' => 1,
				'hook' => Hook::getIdByName('displayExtraSlider10'),
				'nb_column1' => 5,
				'nb_column2' => 4,
				'nb_column3' => 3,
				'nb_column4' => 1,
	...
	public function hookHeader()
	{
		...
		$this->context->controller->registerJavascript('modules-spextraslider', 'modules/'.$this->name.'/views/js/spextraslider.js', ['position' => 'bottom', 'priority' => 150]);
	...
	public function hookDisplayExtraSlider4()
	{
		...
		return $this->display (__FILE__, 'default4.tpl');
	}
	...
	public function hookDisplayExtraSlider9()
	{
		$smarty = $this->context->smarty;
		$smarty_cache_id = $this->getCacheId ('spextraslider_displayExtraSlider9');
			$list = $this->getItemInHook ('displayExtraSlider9');
			if (empty( $list))
				return;
			$smarty->assign (array(
				'list' => $list,
	...
	public function hookDisplayExtraSlider10()
	{
		$smarty = $this->context->smarty;
		$smarty_cache_id = $this->getCacheId ('spextraslider_displayExtraSlider10');
			$list = $this->getItemInHook ('displayExtraSlider10');
			if (empty( $list))
				return;
			$smarty->assign (array(
				'list' => $list,
