...
class SpManufactureSlider extends Module
{
	...
	public function __construct()
	{
		...
		$this->description = $this->l('Display brands on slider.');
	...
	public function installFixtures()
	{
		...
		$datas = array(
			...
			array(
				'id_spmanufactureslider' => 2,
				'display_title_module' => 0,
				'title_module' => 'Featured Brands',
				'moduleclass_sfx' => 'our_brands',
				'active' => 1,
				'hook' => Hook::getIdByName('displayManufacturerSlider2'),
				'nb_column1' => 5,
				'nb_column2' => 4,
				'nb_column3' => 3,
				'nb_column4' => 1,
	...
	public function hookHeader()
	{
			...
			$this->context->controller->registerJavascript('modules-spmanufactureslider', 'modules/'.$this->name.'/views/js/spmanufactureslider.js', ['position' => 'bottom', 'priority' => 150]);
	}
