                    ...
                    <form class="sprsearch-form {$display_box_select|escape:'html':'UTF-8'}" method="get" action="{$search_controller_url}">
                        ...
                        {/foreach}
							<div class="spr_selector">
                                ...
                                <span class="searchproLabel">{l s='All Categories' d='Shop.Theme'}</span>
									...
									{foreach $products as $key => $pro}
										...
										<option value="{$pro.id_option|escape:'html':'UTF-8'}">
											{if $count2 == 1 && $items->params.display_category_all == 1}
												{l s='All Categories' d='Shop.Theme'}
											{else}
						...
						<div class="content-search">	
                            <input class="spr-query" type="text" name="s"
                                   ...
                                   placeholder="{l s='Enter Your Keyword' d='Shop.Theme'}"/>
                            <button value="{l s='Search' d='Shop.Theme'}" class="spr-search-button" type="submit" name="spr_submit_search">
