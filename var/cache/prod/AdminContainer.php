...
class AdminContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'shop', 'user' => 'ramaba', 'password' => 'Saliaba@rm.2019', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.1, 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : ($this->services['annotation_reader'] = new \Doctrine\Common\Annotations\AnnotationReader())) && false ?: '_'}, [0 => '/var/www/html/SENSHOP/modules/productcomments/src/Entity']);
        $c->addExcludePaths([0 => '/var/www/html/SENSHOP/modules/productcomments/src/Entity/index.php']);
        ...
        $a->setProxyDir('/var/www/html/SENSHOP/var/cache/prod//doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_ef10c5de43b6cb021319907aed4f42cceb2b1b735f2b872143a66c63c1bac1da');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/var/www/html/SENSHOP/var/cache/prod//localization');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'database_port' => '',
            'database_name' => 'shop',
            'database_user' => 'ramaba',
            'database_password' => 'Saliaba@rm.2019',
            'database_prefix' => 'ps_',
            ...
            'secret' => 'iq5YYTUTBtBruKhwI5qt1hqVc0Rpn1JDUenucU59vzong7QmpS2JdnT5',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2019-07-22',
            'locale' => 'fr-FR',
            'cookie_key' => '9ygdzBDsBwpwEOydo7TJwRRrPAG5y8nPLVL7U6CorgdaNm2kOSe47hHR',
            'cookie_iv' => 'fUTW1fAM',
            'new_cookie_key' => 'def00000d488d58ac31f316020e73ccd921efb15ff710aaf83374910d42b5a042f216c3950376ab1293b5138d1cdf0a658199b9e3aa0f7d3ed60c6a8bc04b3fe0ff196e7',
            'cache.driver' => 'array',
            'kernel.bundles' => [

            ],
            'kernel.root_dir' => '/var/www/html/SENSHOP/app/',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/var/www/html/SENSHOP/var/cache/prod/',
            'kernel.active_modules' => [
                ...
                69 => 'ps_specials',
                70 => 'spthemeconfigurator',
                71 => 'spextraslider',
                72 => 'spbanner',
                73 => 'spblockcart',
                74 => 'spblockcurrency',
                75 => 'spblocklanguage',
                76 => 'spblocknewsletter',
                77 => 'spblockuserinfo',
                78 => 'spcustomhtml',
                79 => 'splistingtabs',
                80 => 'spsupercategory',
                81 => 'sphomeslider',
                82 => 'spmanufactureslider',
                83 => 'spmegamenu',
                84 => 'spsearchpro',
                85 => 'spfooterlinks',
                86 => 'spdeal',
                87 => 'spstepcheckout',
                88 => 'smartblog',
                89 => 'smartbloghomelatestnews',
                90 => 'productcomments',
                91 => 'spcountdownproduct',
                92 => 'sptwitterslider',
                93 => 'spverticalmenu',
            ],
            'ps_cache_dir' => '/var/www/html/SENSHOP/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/html/SENSHOP/var/cache/prod//doctrine/orm/Proxies',
